...
const AddBank = ({ currUser }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Simply navigate to Step 2 with bank data
      navigate(`/${currUser}/add_account`, {
        state: {
          bankData: { BankName, IFSC, Branch },
        },
      });
    } catch (err) {
        ...
        ">
          ...
          <form className="space-y-7" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <FloatingInput label="Location" name="Location" />
            </div>
